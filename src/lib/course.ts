...
/** Pořadí a názvy odpovídají Thinkificu. */
export const lessons: Lesson[] = [
  {
    slug: 'proc-rikat',
    title: 'Dětem je potřeba o rozvodu říct',
    order: 1,
  ...
  {
    slug: 'co-rikat',
    title: 'Jaké věty pomohou a jaké ublíží',
    order: 2,
  ...
  },
  {
    ...
    title: 'Jakou péči od vás podle věku potřebují',
    order: 3,
